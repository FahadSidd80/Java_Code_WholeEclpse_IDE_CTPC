...
//		
//		System.out.println("The distance between two points of earth is : " + distance_Between_LatLong(lat1, long1, lat2, long2) );
//		// x1 x2 x1 x2 y1 -y2
//		public static double distance_Between_LatLong(double lat1, double long1, double lat2, double long2) {
//			lat1 = Math.toRadians(lat1); // x1
//			long1 = Math.toRadians(long1); // y1
//			lat2 = Math.toRadians(lat2); // x2
//			long2 = Math.toRadians(long2);  // y2
...
//		
//		Scanner sc = new Scanner(System.in);
//		System.out.println("Enter a value for you want table : ");
//		int x = sc.nextInt();
//		for(int i=1; i<=10;i++) {
